...
class Add_Social_Share_Buttons_Plugin {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action('admin_post_nopriv_submit-form',$plugin_admin, 'whatsapp_share_setting_add_update');
		$this->loader->add_action('admin_post_add-service-form',$plugin_admin,  'whatsapp_share_add_remove_services');
		$this->loader->add_action('admin_post_nopriv_add-service-form',$plugin_admin, 'whatsapp_share_add_remove_services');
		
		$this->loader->add_action('admin_post_reorder-service-form',$plugin_admin,  'whatsapp_share_reorder_services');
		$this->loader->add_action('admin_post_nopriv_reorder-service-form',$plugin_admin, 'whatsapp_share_reorder_services');
		
		$this->loader->add_action( 'wp_ajax_add_plugin_user_assb', $plugin_admin, 'wp_add_plugin_userfn_assb' );
		$this->loader->add_action( 'wp_ajax_hide_subscribe_assb', $plugin_admin, 'hide_subscribe_assbfn' );
        ...
        $this->loader->add_action('woocommerce_assb_other_plugins', $plugin_admin, 'woocommerce_assb_other_plugins');
