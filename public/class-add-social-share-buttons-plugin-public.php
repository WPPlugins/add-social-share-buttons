...
class Add_Social_Share_Buttons_Plugin_Public {
                    ...
                    if (in_array($getPostType, $get_share_settings['share_posttype'])) {
                        ...
                        if ($get_services['share_button'] != '' && !empty($get_services['share_button'])) {
                            ...
                            foreach ($get_services['share_button'] as $key => $values) {
                                if ($values == 'Facebook') {
                                    ...
                                    $html .='<a href=""><span class="social-facebook assbshareonfbbtn"><img src="' . $sharebuttonArray[$values] . '" alt="' . $values . '"></span></a>';
                                } elseif ($values == 'Google_plus') {
                                    $html .='<a href="javascript:void(0);" onclick="return googleplus()" class="social-googleplus"><img src="' . $sharebuttonArray[$values] . '" alt="' . $values . '"></a>';
                                } elseif ($values == 'Twitter') {
                                    $html .='<a href="https://twitter.com/intent/tweet?url=' . esc_url(get_permalink($post->ID)) . ';size=l&amp;count=none" class="social-twitter"><img src="' . $sharebuttonArray[$values] . '" alt="' . $values . '"></a>';
                                } elseif ($values == 'Whatsapp') {
                                    $html .='<a class="woo_shre_whatsapp_btn" data-text="' . $post->post_title . '" data-link="' . esc_url(get_permalink($post->ID)) . '" href="javascript:void(0);"><img src="' . $sharebuttonArray[$values] . '" alt="' . $values . '"></a>';
                                } elseif ($values == 'Viber') {
                                    $html .='<a class="woo_shre_viber_btn" data-text="' . $post->post_title . '" data-link="' . esc_url(get_permalink($post->ID)) . '" href="javascript:void(0);"><img src="' . $sharebuttonArray[$values] . '" alt="' . $values . '"></a>';
                                } elseif ($values == 'Linkedin') {
                                    //$html .='<a href="'.$shareUrlArray[$values].'"><img src="'.$sharebuttonArray[$values].'" alt="'.$values.'"></a>';
                                    $html .='<a href="javascript:void(0);" onclick="return linkdin()"><img src="' . $sharebuttonArray[$values] . '" alt="' . $values . '"></a>';
                                }
                            }
                            $html .='</div>';
                        ...
                        <script type="text/javascript">
                            ...
                            function linkdin() {
                                ...
                                var url = "url=" + encodeURIComponent('<?php echo esc_url(get_permalink($post->ID)); ?>');
                                var title = 'title=<?php echo $post->post_title; ?>';
                                javascript:void
    ...
    function add_shre_button_on_woocommerce_details_page() {
            ...
            if ($get_services['share_button'] != '' && !empty($get_services['share_button'])) {
                ...
                foreach ($get_services['share_button'] as $key => $values) {
                    if ($values == 'Facebook') {
                        ...
                        $html .='<a href="https://twitter.com/intent/tweet?url=' . $requestPageUrl . ';size=l&amp;count=none" class="social-twitter"><img src="' . $sharebuttonArray[$values] . '" alt="' . $values . '"></a>';
                    } elseif ($values == 'Whatsapp') {
                        $html .='<a class="woo_shre_whatsapp_btn" data-text="' . $pageTitle . '" data-link="' . $requestPageUrl . '" href="javascript:void(0);"><img src="' . $sharebuttonArray[$values] . '" alt="' . $values . '"></a>';
                    } elseif ($values == 'Viber') {
                        $html .='<a class="woo_shre_viber_btn" data-text="' . $pageTitle . '" data-link="' . $requestPageUrl . '" href="javascript:void(0);"><img src="' . $sharebuttonArray[$values] . '" alt="' . $values . '"></a>';
                    } elseif ($values == 'Linkedin') {
                        $html .='<a href="javascript:void(0);" onclick="return linkdin()"><img src="' . $sharebuttonArray[$values] . '" alt="' . $values . '"></a>';
                    }
                }
        ...
        <script type="text/javascript">
            ...
            function shareonfacebook(title, desc, url, image) {
                ...
                var share_url = '<?php echo $requestPageUrl; ?>';
    ...
    function add_custom_whatsapp_share_styles() {
        ...
        if (isset($get_share_settings['include_custom_styles']) && !empty($get_share_settings['include_custom_styles'])) {
            ...
            echo '<style>' . $get_share_settings['include_custom_styles'] . '</style>';
        }
    }
